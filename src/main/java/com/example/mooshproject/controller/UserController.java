...
import com.example.mooshproject.dtos.ChangePasswordRequest;
...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserDto> putUser(@PathVariable Long id, @RequestBody UpdateUserRequest request ){
        var user = userRepository.findById(id).orElse(null);
        if(user == null){
            return ResponseEntity.notFound().build();
        }
