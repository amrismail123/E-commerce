...
import com.example.mooshproject.dtos.JwtResponse;
import com.example.mooshproject.dtos.LoginRequest;
import com.example.mooshproject.dtos.UserDto;
import com.example.mooshproject.mappers.UserMapper;
import com.example.mooshproject.repository.UserRepository;
import com.example.mooshproject.service.JwtService;
...
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> loginUser(@Valid @RequestBody LoginRequest request,
        ...
        cookie.setMaxAge(jwtConfig.getRefreshTokenExpirationTime());
